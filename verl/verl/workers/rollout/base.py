...
_ROLLOUT_REGISTRY = {
    ...
    ("vllm_multi_turn_tool_call", "async"): "verl.workers.rollout.vllm_rollout.vLLMAsyncRollout",
    ("vllm_video_o3", "sync"): "verl.workers.rollout.vllm_rollout.vLLMVideoO3Rollout",
