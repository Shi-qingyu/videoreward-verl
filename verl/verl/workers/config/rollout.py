...
class RolloutConfig(BaseConfig):
    ...
    max_generation_round: int = 4

    val_max_generation_round: int = 1

    vllm_infer_batch_size: int = 8

    max_observation_frames: int = 12

    max_pixels: Optional[int] = None

    min_pixels: Optional[int] = None

    max_total_response_length: Optional[int] = None
    ...
    val_limit_mm_per_prompt: dict = field(default_factory=dict)

    multi_turn_prompt_type: str = "v2"
