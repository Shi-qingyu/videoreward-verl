...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        use_multi_turn_response_mask (bool): Whether to mask responses by assistant turns in multi-turn rollouts.
        ignore_exceed (bool): Whether to ignore overlong/exceeding samples in async multi-turn rollout paths.
    ...
    use_multi_turn_response_mask: bool = False
