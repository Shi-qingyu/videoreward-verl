...
project_name='highlight_exp'
exp_name='4b_ins_sft_gspo'
...
model_path=/mnt/bn/strategy-mllm-train/user/zjn/checkpoints/qwen3vl_4b_instruct_batch1345_v3_60/checkpoint-11000/hf_ckpt
...
data_path=${nas_path}/highlight_data

train_0=${data_path}/data/sft_v2/fyp_1105_trainset_part1_0.parquet
train_1=${data_path}/data/sft_v2/fyp_1105_trainset_part1_5000.parquet
train_2=${data_path}/data/sft_v2/fyp_1105_trainset_part1_10000.parquet
train_3=${data_path}/data/sft_v2/fyp_1105_trainset_part1_15000.parquet
train_4=${data_path}/data/sft_v2/fyp_1105_trainset_part1_20000.parquet
train_5=${data_path}/data/sft_v2/fyp_1105_trainset_part1_25000.parquet
eval_new=${data_path}/data/sft_v2/fyp_test_800_0.parquet

train_files="['$train_0', '$train_1', '$train_2', '$train_3', '$train_4', '$train_5']"
eval_files="['$eval_new']"

custom_reward_function_path=${base_path}/reward_system/reward.py
custom_reward_function_name=batch_highlight_reward_fn
