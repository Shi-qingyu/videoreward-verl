...
project_name='open-o3-video-verl-debug-bzy'
exp_name='grpo_debug'
...
# Paths
base_path="$(pwd)"
model_path=/mnt/bn/strategy-mllm-train/intern/users/baozhongyuan/models/open-o3-video/sft_qwen3vl_4b_31k_1123
...
export DATA_ROOT="/mnt/bn/strategy-mllm-train/intern/users/baozhongyuan/projects/data/Open-o3-Video/"
train=/mnt/bn/strategy-mllm-train/intern/users/baozhongyuan/datasets/open-o3-video-data/samples_cleaned.parquet
eval=/mnt/bn/strategy-mllm-train/intern/users/baozhongyuan/datasets/open-o3-video-data/samples_cleaned.parquet
