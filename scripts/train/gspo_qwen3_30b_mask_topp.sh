...
exp_name='v1_8_gspo_clip_is_topp_30b'
...
clip_ratio_low=0.015
clip_ratio_high=0.015

max_prompt_length=$((1024 * 88))
...
model_path=${nas_path}/base_models/Qwen3-30B-A3B-Instruct-2507
...
# 这里需要bs/gpu_num/micro_batch_size_per_gpu是整数
...
python3 -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.nccl_timeout=${timeout} \
    ...
    +actor_rollout_ref.rollout.engine_kwargs.sglang.watchdog_timeout=${timeout} \
    ...
    trainer.ray_wait_register_center_timeout=${timeout} \
