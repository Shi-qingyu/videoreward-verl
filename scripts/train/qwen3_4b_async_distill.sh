...
exp_name='v1_8_vllm_async_4b'

adv_estimator=teacher_logprob
...
train_prompt_bsz=$((train_prompt_mini_bsz * 1))

# Paths
base_path=/opt/tiger/live_strategy_posttrain
nas_path=/mnt/bn/strategy-mllm-train/user/hjy
model_path=${nas_path}/base_models/Qwen3-4B-Instruct-2507
...
# reasoning_train_path=${data_path}/data/debug_single_turn_19_0613.parquet
# reasoning_test_path=${data_path}/data/debug_single_turn_19_0613_eval.parquet
# single_turn_gemini_0613=${data_path}/data/single_turn_gemini_bench_0613_eval.parquet
...
# single_turn_0620=${data_path}/data/single_turn_claude_0620_train.parquet
# single_turn_0621=${data_path}/data/single_turn_claude_qwen_0621_train.parquet
# single_turn_0622=${data_path}/data/single_turn_claude_qwen_0622_train.parquet
single_turn_gemini_0813=${data_path}/data/single_turn_gemini_0813_train_v2.parquet
# react_0818=${data_path}/data/react_gemini_0818_train.parquet
...
custom_reward_function_name=analysis_reward_async
...
PYTHONUNBUFFERED=1 python3 -u -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode="reverse_kl" \
